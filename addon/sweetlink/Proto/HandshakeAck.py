...
def HandshakeAckAddApiKey(builder: octoflatbuffers.Builder, apiKey: int):
    builder.PrependUOffsetTRelativeSlot(5, octoflatbuffers.number_types.UOffsetTFlags.py_type(apiKey), 0)

def AddApiKey(builder: octoflatbuffers.Builder, apiKey: int):
    HandshakeAckAddApiKey(builder, apiKey)
