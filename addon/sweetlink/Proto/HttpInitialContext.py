...
from sweetlink.Proto.HttpHeader import HttpHeader
...
def HttpInitialContextAddHost(builder: octoflatbuffers.Builder, host: int):
    builder.PrependUOffsetTRelativeSlot(3, octoflatbuffers.number_types.UOffsetTFlags.py_type(host), 0)
