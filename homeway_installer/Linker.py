...
class Linker:
    ...
    def _PrintShortCodeStyleOrFullUrl(self, addonId:str) -> None:
        ...
        try:
            ...
            r = requests.post(os.environ.get("HOMEWAY_URL", "https://homeway.io") + "/api/shortcode/create", json={"Type": 1, "PluginId": addonId}, timeout=10.0)
    ...
    def _IsAddonConnectedToAnAccount(self, addonId:str) -> Tuple[bool, Optional[str]]:
        ...
        while True:
            try:
                ...
                r = requests.post(os.environ.get("HOMEWAY_URL", "https://homeway.io") + "/api/plugin/info", json={"Id": addonId}, timeout=20)
